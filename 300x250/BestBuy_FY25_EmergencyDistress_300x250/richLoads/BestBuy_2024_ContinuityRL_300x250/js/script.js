...
// return;
            ...
            christmasTL.to(bestBuyLogo, 0.5, {opacity: 0, delay: 2,}, "-=0.5")
                .set(bestBuyLogo, {scale: .6, x: -95, y: -84, z: .01});
            ...
            // return;
            christmasTL.to(CI_Frame2CopyCont, 1, {x: -5, ease: Linear.easeNone}, "frame2")
                .to(CI_Frame2CopyCont, 1.7, {x: -20, ease: Linear.easeNone, delay: -.1})
    ...
    //            christmasTL.pause(); 
            ...
            christmasTL.to(icon1, 1, {x: 30, ease: "none", delay: -.6});
        ...
        preloadChristmasIntroFrame: function () {
            ...
            Ad.preloadChristmasIntroFrameImage(document.getElementById("bestBuyLogo"), "images/christmasIntroAssets/image_300x250_logo_CircleR_v03.svg");
        ...
        animate : function() {
            ...
            function zoomIn() {
                ...
                TweenMax.to([arrow_left], 0.5, {opacity: 1, display:'block', left:'-63px', ease: Strong.easeInOut, delay:0.1}); // slide in
                TweenMax.to([arrow_right], 0.5, {opacity: 1, display:'block', right:'-63px', ease: Strong.easeInOut, delay:0.1}); // slide in
            }
            ...
            function moveCarousel() {
                ...
                for(var i = 0; i < (carouselItems.length-1); i++){
                    ...
                    Ad.moveTL.to(carouselItems[i],.35,{left:-Ad.WIDTH,ease:Strong.easeOut},'autoFrames'+i);
                    Ad.moveTL.to(carouselItems[i+1],.35,{left:0,ease:Strong.easeOut,onComplete:function(){
                        currentFrame++;
                ...
                Ad.moveTL.to(carouselItems[id],1.3,{opacity:0,ease: Strong.easeOut},"prodOut");
            ...
            function animateEndFrame () {
                ...
                //ARROWS
                TweenMax.to(arrow_left,.35,{left:"-20px",delay:.5});
                TweenMax.to(arrow_right,.35,{right:"-20px",delay:.5});
                ...
                TweenMax.to(carousel, 0.5, {opacity: 1, ease: Strong.easeOut, delay:.05,onComplete:function () {
                    ...
                    if(products_info.length > 2){
                        ...
                        TweenMax.to(rightItem, 0.5, {left: 142, ease: Strong.easeInOut, delay:.15});
                        
                        leftItem = products_info[products_info.length-1].slide;
                        TweenMax.set(leftItem,{opacity:.7});
                        TweenMax.to(leftItem, 0.5, {left: -143, ease: Strong.easeInOut, delay:.15});
                    } else {
                        rightItem = products_info[1].slide;
                        // TweenMax.set(rightItem,{opacity:.7});
                        TweenMax.to(rightItem, 0.5, {left: 145, ease: Strong.easeInOut, delay:.15});
                    }
                }});
        ...
        resetCarousel : function(e){
            ...
            //ARROWS
            TweenMax.to(arrow_left,.35,{left:"-=45px"});
            TweenMax.to(arrow_right,.35,{right:"-=45px"});
        ...
        onArrowClick : function(e) {
            ...
            if(!f2Done) {
                ...
                if(isRightClick) {
                    ...
                    TweenMax.set(carouselItems[currentFrame], {x: Ad.WIDTH, left: 0})
                    TweenMax.to(currentItem, .5, {x: -1 * Ad.WIDTH, delay: .1});
                    TweenMax.to(carouselItems[currentFrame], .5, {x: 0, delay: .1, onComplete: () => block_click = false});
                } else {
                    currentFrame--
                    if(currentFrame < 0) {
                        currentFrame = carouselItems.length - 1;
                    }
                    TweenMax.set(carouselItems[currentFrame], {x: - 1 * Ad.WIDTH, left: 0});
                    TweenMax.to(currentItem, .5, {x: Ad.WIDTH, delay: .1});
                    TweenMax.to(carouselItems[currentFrame], .5, {x: 0, delay: .1, onComplete: () => block_click = false});
                }
            ...
            var elm =  [
                document.getElementById('slide'+currentFrame)];//element to slide out
        ...
        addElements : function() {
            ...
            // images
            logo2.style.backgroundImage = "url('images/bb_logo_300x250.png')";
