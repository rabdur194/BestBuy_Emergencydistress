FT.manifest({
    ...
    "clickTagCount": 7,
    "richLoads": [
        { "name": "Richload",                   "src": "BestBuy_2024_ContinuityRL_320x480" }
    ],
    "instantAds":[
        {"name": "Richload",            "type": "richLoad",     "default": "BestBuy_2024_ContinuityRL_320x480" },
		...
		{"name": "Frame_4_Headline", 	"type": "image",  "default": "MappGot_2024_320x480.png"},
		{"name": "Icon1", 	 	        "type": "image", "default": "free_delivery_320x480.png"},
	    ...
	    {"name": "default_fallback_image", 	  		"type": "image", "default": "FY2024_HolidayDefault_320x480.jpg"}
