...
var Banner = {
	...
	init: function () {
		myFT.addEventListener("instantads", function () {
			...
			Images.add("images/FY2024_withoutGlowBG_300x600.png", logo);
			
			Images.add("images/arrow_next.png", arrow_next);
			Images.add("images/arrow_prev.png", arrow_prev);

			Images.add("images/FY2024_bg_300x600.jpg", testImg);
			...
			Images.add("images/image_300x600_logo_CircleR_v03.svg", intro_logo);
	...
	playIntro: function () {
		...
		introTL.to(intro_logo, 0.5, {delay: 2, opacity:0}, "-=0.5")
			.set(intro_logo, {scale: .68, x: -76,y:-228, z: .01});
	...
	playEndFrame: function () {
		...
		endFrameTL.to([carousel_items, ".product-info, .product-cta"], 0.35, {
			...
			onComplete: function () {
				...
				endFrameTL.set(".product.active .product-image", { marginTop: 125 }, "fadein");
		...
		endFrameTL.set("#product_1 .product-cta", { x:-9,y: 173,scale:0.92},"fadein"); 
		endFrameTL.to(legal, 0.35, { opacity: 1 }, "fadein");
		endFrameTL.to(arrow_prev, 0.35, { y: 37}, "fadein");
		endFrameTL.to(arrow_next, 0.35, { y: -127}, "fadein");
		endFrameTL.add(function () {
			...
			if (nextItem) {
				...
				endFrameTL.fromTo(nextItem, { y: "100%" }, { duration: 0.35, y: 175 }, "shrink+=0.35");
			}
			if (lastItem && lastItem !== nextItem && lastItem !== currItem) {
				...
				endFrameTL.fromTo(lastItem, { y: "-100%" }, { duration: 0.35, y: -130 }, "shrink+=0.35");
			}
